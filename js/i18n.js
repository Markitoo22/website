...
(function () {
  ...
  var DICT = {
    ...
    es: {
      ...
      close_h: '¿Arrancamos?',
      cta_close: 'Pedir mi diagnóstico gratis',
      note_close: 'Coordinamos día y horario',
      session_lang: 'Las sesiones son en español o inglés.',
      f_title: 'Reservá tu diagnóstico gratis',
      f_sub: 'Son 30 segundos. Te respondo por WhatsApp el mismo día.',
      f_nombre: 'Nombre',
      f_nombre_ph: 'Tu nombre',
      f_tel: 'Número de WhatsApp',
      f_tel_ph: 'Tu número',
      f_pais: 'País',
      f_tel_eco: 'Te escribo acá:',
      f_tel_falta: 'Faltan dígitos',
      f_pc: '¿Qué tipo de PC tenés?',
      f_pc1: 'Notebook',
      f_pc2: 'PC de escritorio',
      f_prob: '¿Cuál es el problema principal?',
      f_p1: 'Juegos lentos (pocos FPS)',
      f_p2: 'Anda lenta en general',
      f_p3: 'Tarda mucho en arrancar',
      f_p4: 'Se calienta o hace mucho ruido',
      f_p5: 'Se traba o se reinicia sola',
      f_p6: 'Optimización general',
      f_p7: 'Necesito programas',
      f_p8: 'No sé qué tiene, quiero que ande mejor',
      f_elegi: 'Elegí una opción',
      f_ok: 'Entiendo que el diagnóstico es gratuito y 100% a distancia. El precio y la duración final del servicio pueden variar según las características de mi PC, mi velocidad de internet y la complejidad de la operación.',
      f_enviar: 'Confirmar diagnóstico gratis',
      f_abriendo: 'Abriendo WhatsApp…',
      f_escape: '¿No se abrió? Abrilo acá',
      f_cerrar: 'Cerrar',
      f_falta: 'Te falta completar esto',
      f_msg: '¡Hola! Soy {nombre}. Quiero el - DIAGNÓSTICO GRATIS - para mi {pc} porque tengo el problema de: {problema}.',
    ...
    en: {
      ...
      close_h: 'Shall we?',
      cta_close: 'Get my free diagnosis',
      note_close: "We'll pick a day and time",
      session_lang: 'Sessions are run in Spanish or English.',
      f_title: 'Book your free diagnosis',
      f_sub: 'Takes 30 seconds. I reply on WhatsApp the same day.',
      f_nombre: 'Name',
      f_nombre_ph: 'Your name',
      f_tel: 'WhatsApp number',
      f_tel_ph: 'Your number',
      f_pais: 'Country',
      f_tel_eco: 'I\'ll message you here:',
      f_tel_falta: 'A few digits missing',
      f_pc: 'What kind of PC do you have?',
      f_pc1: 'Laptop',
      f_pc2: 'Desktop PC',
      f_prob: 'What is the main problem?',
      f_p1: 'Slow games (low FPS)',
      f_p2: 'Generally slow',
      f_p3: 'Takes ages to start up',
      f_p4: 'Runs hot or noisy',
      f_p5: 'Freezes or restarts on its own',
      f_p6: 'General tune-up',
      f_p7: 'I need software installed',
      f_p8: 'Not sure what\'s wrong, I just want it faster',
      f_elegi: 'Pick one',
      f_ok: 'I understand the diagnosis is free and 100% remote. The final price and duration may vary depending on my PC, my internet speed and the complexity of the job.',
      f_enviar: 'Confirm free diagnosis',
      f_abriendo: 'Opening WhatsApp…',
      f_escape: 'Didn’t open? Open it here',
      f_cerrar: 'Close',
      f_falta: 'This one is still missing',
      f_msg: 'Hi! I\'m {nombre}. I want the - FREE DIAGNOSIS - for my {pc} because I have this problem: {problema}.',
    ...
    pt: {
      ...
      close_h: 'Vamos?',
      cta_close: 'Quero meu diagnóstico grátis',
      ...
      f_title: 'Agende seu diagnóstico grátis',
      f_sub: 'Leva 30 segundos. Respondo pelo WhatsApp no mesmo dia.',
      f_nombre: 'Nome',
      f_nombre_ph: 'Seu nome',
      f_tel: 'Número de WhatsApp',
      f_tel_ph: 'Seu número',
      f_pais: 'País',
      f_tel_eco: 'Escrevo para você aqui:',
      f_tel_falta: 'Faltam dígitos',
      f_pc: 'Que tipo de PC você tem?',
      f_pc1: 'Notebook',
      f_pc2: 'PC de mesa',
      f_prob: 'Qual é o problema principal?',
      f_p1: 'Jogos lentos (FPS baixo)',
      f_p2: 'Lenta em geral',
      f_p3: 'Demora muito para ligar',
      f_p4: 'Esquenta ou faz muito barulho',
      f_p5: 'Trava ou reinicia sozinha',
      f_p6: 'Otimização geral',
      f_p7: 'Preciso de programas',
      f_p8: 'Não sei o que tem, quero que ande melhor',
      f_elegi: 'Escolha uma opção',
      f_ok: 'Entendo que o diagnóstico é gratuito e 100% a distância. O preço e a duração final do serviço podem variar conforme as características do meu PC, minha velocidade de internet e a complexidade da operação.',
      f_enviar: 'Confirmar diagnóstico grátis',
      f_abriendo: 'Abrindo o WhatsApp…',
      f_escape: 'Não abriu? Abra aqui',
      f_cerrar: 'Fechar',
      f_falta: 'Falta preencher isto',
      f_msg: 'Olá! Sou {nombre}. Quero o - DIAGNÓSTICO GRÁTIS - para o meu {pc} porque tenho este problema: {problema}.',
      wa: 'Hi! I want a PC tune-up'
    },
    ...
    fr: {
      ...
      close_h: 'On commence ?',
      cta_close: 'Obtenir mon diagnostic gratuit',
      note_close: 'On choisit le jour et l’heure',
      session_lang: 'Les sessions se déroulent en espagnol ou en anglais.',
      f_title: 'Réservez votre diagnostic gratuit',
      f_sub: '30 secondes. Je réponds sur WhatsApp le jour même.',
      f_nombre: 'Prénom',
      f_nombre_ph: 'Votre prénom',
      f_tel: 'Numéro WhatsApp',
      f_tel_ph: 'Votre numéro',
      f_pais: 'Pays',
      f_tel_eco: 'Je vous écris ici :',
      f_tel_falta: 'Il manque des chiffres',
      f_pc: 'Quel type de PC avez-vous ?',
      f_pc1: 'Ordinateur portable',
      f_pc2: 'PC de bureau',
      f_prob: 'Quel est le problème principal ?',
      f_p1: 'Jeux lents (peu de FPS)',
      f_p2: 'Lente en général',
      f_p3: 'Très longue à démarrer',
      f_p4: 'Elle chauffe ou fait du bruit',
      f_p5: 'Elle plante ou redémarre toute seule',
      f_p6: 'Optimisation générale',
      f_p7: 'J\'ai besoin de logiciels',
      f_p8: 'Je ne sais pas ce qu\'elle a, je veux qu\'elle aille mieux',
      f_elegi: 'Choisissez une option',
      f_ok: 'Je comprends que le diagnostic est gratuit et 100 % à distance. Le prix et la durée finale du service peuvent varier selon les caractéristiques de mon PC, ma connexion et la complexité de l\'intervention.',
      f_enviar: 'Confirmer le diagnostic gratuit',
      f_abriendo: 'Ouverture de WhatsApp…',
      f_escape: 'Ça ne s’ouvre pas ? Ouvrez-le ici',
      f_cerrar: 'Fermer',
      f_falta: 'Il manque encore ceci',
      f_msg: 'Bonjour ! Je suis {nombre}. Je veux le - DIAGNOSTIC GRATUIT - pour mon {pc} car j\'ai ce problème : {problema}.',
      wa: 'Hi! I want a PC tune-up'
    },
    ...
    de: {
      ...
      cta_close: 'Kostenlose Diagnose anfragen',
      note_close: 'Wir finden Tag und Uhrzeit',
      session_lang: 'Die Sitzungen finden auf Spanisch oder Englisch statt.',
      f_title: 'Sichere dir deine kostenlose Diagnose',
      f_sub: 'Dauert 30 Sekunden. Ich antworte noch am selben Tag über WhatsApp.',
      f_nombre: 'Name',
      f_nombre_ph: 'Dein Name',
      f_tel: 'WhatsApp-Nummer',
      f_tel_ph: 'Deine Nummer',
      f_pais: 'Land',
      f_tel_eco: 'Hier schreibe ich dir:',
      f_tel_falta: 'Es fehlen noch Ziffern',
      f_pc: 'Was für einen PC hast du?',
      f_pc1: 'Notebook',
      f_pc2: 'Desktop-PC',
      f_prob: 'Was ist das Hauptproblem?',
      f_p1: 'Spiele laufen langsam (wenig FPS)',
      f_p2: 'Generell langsam',
      f_p3: 'Startet sehr langsam',
      f_p4: 'Wird heiß oder ist laut',
      f_p5: 'Hängt sich auf oder startet neu',
      f_p6: 'Allgemeine Optimierung',
      f_p7: 'Ich brauche Programme',
      f_p8: 'Ich weiß nicht, was los ist — sie soll besser laufen',
      f_elegi: 'Bitte auswählen',
      f_ok: 'Mir ist klar, dass die Diagnose kostenlos und komplett aus der Ferne erfolgt. Preis und Dauer des Dienstes können je nach meinem PC, meiner Internetgeschwindigkeit und dem Aufwand abweichen.',
      f_enviar: 'Kostenlose Diagnose bestätigen',
      f_abriendo: 'WhatsApp wird geöffnet…',
      f_escape: 'Hat sich nicht geöffnet? Hier öffnen',
      f_cerrar: 'Schließen',
      f_falta: 'Das fehlt noch',
      f_msg: 'Hallo! Ich bin {nombre}. Ich möchte die - KOSTENLOSE DIAGNOSE - für meinen {pc}, weil ich dieses Problem habe: {problema}.',
      wa: 'Hi! I want a PC tune-up'
    },
    ...
    it: {
      ...
      close_h: 'Partiamo?',
      cta_close: 'Voglio la mia diagnosi gratuita',
      note_close: 'Concordiamo giorno e ora',
      session_lang: 'Le sessioni si svolgono in spagnolo o in inglese.',
      f_title: 'Prenota la tua diagnosi gratuita',
      f_sub: 'Ci vogliono 30 secondi. Rispondo su WhatsApp lo stesso giorno.',
      f_nombre: 'Nome',
      f_nombre_ph: 'Il tuo nome',
      f_tel: 'Numero WhatsApp',
      f_tel_ph: 'Il tuo numero',
      f_pais: 'Paese',
      f_tel_eco: 'Ti scrivo qui:',
      f_tel_falta: 'Mancano delle cifre',
      f_pc: 'Che tipo di PC hai?',
      f_pc1: 'Portatile',
      f_pc2: 'PC fisso',
      f_prob: 'Qual è il problema principale?',
      f_p1: 'Giochi lenti (pochi FPS)',
      f_p2: 'Lenta in generale',
      f_p3: 'Ci mette tanto ad avviarsi',
      f_p4: 'Si scalda o fa rumore',
      f_p5: 'Si blocca o si riavvia da sola',
      f_p6: 'Ottimizzazione generale',
      f_p7: 'Mi servono programmi',
      f_p8: 'Non so cosa abbia, voglio che vada meglio',
      f_elegi: 'Scegli un\'opzione',
      f_ok: 'Capisco che la diagnosi è gratuita e totalmente a distanza. Il prezzo e la durata finale del servizio possono variare in base alle caratteristiche del mio PC, alla mia connessione e alla complessità dell\'intervento.',
      f_enviar: 'Conferma diagnosi gratuita',
      f_abriendo: 'Apertura di WhatsApp…',
      f_escape: 'Non si è aperto? Aprilo qui',
      f_cerrar: 'Chiudi',
      f_falta: 'Manca ancora questo',
      f_msg: 'Ciao! Sono {nombre}. Voglio la - DIAGNOSI GRATUITA - per il mio {pc} perché ho questo problema: {problema}.',
      wa: 'Hi! I want a PC tune-up'
    }
  ...
  function pintarPrecio(esAR) {
    /* Lo usa js/formulario.js para el campo de telefono: a un argentino
       se le pide el numero sin el 0 ni el 15 y con el +54 9 ya puesto;
       al resto, con su codigo de pais. El dato ya esta resuelto aca. */
    window.mlpcEsAR = !!esAR;
  ...
  countryFetch(function (cc) {
    if (cc) {
      /* lo usa js/formulario.js para dejar elegido el codigo de pais */
      window.mlpcPais = String(cc).toUpperCase();
      pintarPrecio(window.mlpcPais === 'AR');
